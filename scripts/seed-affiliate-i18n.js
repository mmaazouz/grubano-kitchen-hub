...
const AFF = {
  fr: {
    ...
    statusTitle: 'Statut & classement', tierLabel: 'Palier',
    tierBronze: 'Bronze', tierSilver: 'Argent', tierGold: 'Or', tierPlatinum: 'Platine',
    tierProgress: 'Plus que {amount} pour {tier}', tierMax: 'Palier maximum atteint 🏆',
  ...
  en: {
    ...
    statusTitle: 'Status & leaderboard', tierLabel: 'Tier',
    tierBronze: 'Bronze', tierSilver: 'Silver', tierGold: 'Gold', tierPlatinum: 'Platinum',
    tierProgress: '{amount} to go for {tier}', tierMax: 'Top tier reached 🏆',
  ...
  es: {
    ...
    statusTitle: 'Estado y clasificación', tierLabel: 'Nivel',
    tierBronze: 'Bronce', tierSilver: 'Plata', tierGold: 'Oro', tierPlatinum: 'Platino',
    tierProgress: 'Te faltan {amount} para {tier}', tierMax: 'Nivel máximo alcanzado 🏆',
  ...
  it: {
    ...
    statusTitle: 'Status e classifica', tierLabel: 'Livello',
    tierBronze: 'Bronzo', tierSilver: 'Argento', tierGold: 'Oro', tierPlatinum: 'Platino',
    tierProgress: 'Ancora {amount} per {tier}', tierMax: 'Livello massimo raggiunto 🏆',
  ...
  ar: {
    ...
    statusTitle: 'الحالة والترتيب', tierLabel: 'المستوى',
    tierBronze: 'برونزي', tierSilver: 'فضي', tierGold: 'ذهبي', tierPlatinum: 'بلاتيني',
    tierProgress: 'تبقّى {amount} للوصول إلى {tier}', tierMax: 'تم بلوغ أعلى مستوى 🏆',
